  ...
  return (
    ...
    <div className="bg-gradient-to-r from-green-500 to-green-600 text-white px-4 md:px-6 pt-2 md:pt-3 pb-3 md:pb-5 shadow-lg flex-shrink-0" style={{ minHeight: '68px', position: 'relative' }}>
      <div className="flex items-center justify-between">
          ...
          {/* Fixed footer with buttons - Responsive layout */}
          <div className="bg-white px-3 md:px-6 py-2 md:py-3 border-t-2 border-gray-200 shadow-2xl flex-shrink-0">
            {/* Desktop: horizontal layout con timestamp visible */}
            ...
            {/* Mobile: layout vertical compacto sin timestamp */}
            <div className="flex md:hidden flex-col gap-2">
              <div className="flex gap-2">
                <button 
                  onClick={onClose} 
                  className="flex-1 px-3 py-2.5 text-xs font-semibold text-gray-700 bg-white border-2 border-gray-300 hover:bg-gray-50 hover:border-gray-400 rounded-lg transition-all shadow-sm hover:shadow cursor-pointer flex items-center justify-center gap-1.5"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                  </svg>
                ...
                <button 
                  onClick={handleSendForApproval}
                  disabled={pendingApproval || (isEditing && editingTraining?.pendingApproval)}
                  className={`flex-1 px-3 py-2.5 rounded-lg text-xs font-bold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-1.5 ${
                    pendingApproval || (isEditing && editingTraining?.pendingApproval)
                      ? 'bg-gray-400 cursor-not-allowed text-white'
                      : 'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white cursor-pointer'
                  }`}
              ...
              <button 
                onClick={handleSave} 
                className="w-full px-3 py-2.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg text-xs font-bold shadow-lg hover:shadow-xl transition-all cursor-pointer flex items-center justify-center gap-1.5"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
