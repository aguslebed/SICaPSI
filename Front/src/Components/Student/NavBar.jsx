        ...
        <div className="w-full mx-auto h-12 md:h-14 flex items-center" style={{ maxWidth: '1400px', padding: '0 2.5rem' }}>
          ...
          {shouldShowBackButton && (
            <button
              ...
              className="flex items-center justify-center gap-2 text-white bg-[#4dc3ff] hover:bg-[#3bb3ef] px-5 py-2 rounded-full transition-all cursor-pointer shadow-sm hover:shadow-md font-medium text-sm"
