...
function ActualizarUsuario() {
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 py-6">
        <section className="w-full max-w-3xl bg-white/95 shadow-2xl rounded-2xl p-4 sm:p-6 md:p-8">
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-3">
              <select className="border rounded-lg px-3 py-2 w-full cursor-pointer text-sm" value={documentType} onChange={e => setdocumentType(e.target.value)}>
                <option value="">Tipo de documento</option>
                <option value="DNI">DNI</option>
                <option value="CUIL/CUIT">CUIL/CUIT</option>
                <option value="Pasaporte">Pasaporte</option>
              </select>
              <input type="text" placeholder="Número" className="border rounded-lg px-3 py-2 w-full text-sm" value={documentNumber} onChange={e => setdocumentNumber(e.target.value)} />
              <input type="date" className="border rounded-lg px-3 py-2 w-full text-sm" value={birthDate} onChange={e => setbirthDate(e.target.value)} />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-3">
              <input
                ...
                className="border rounded-lg px-3 py-2 col-span-1 text-sm"
                value={address}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3">
              <select
                className="border rounded-lg px-3 py-2 w-full max-h-48 overflow-y-auto cursor-pointer text-sm"
                value={province}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {ROLE_OPTIONS.map((opt) => (
                  <button
                    ...
                    type="button"
                    className={
                      "px-2 py-1.5 rounded-lg border transition cursor-pointer text-sm " +
            ...
            <button
              type="submit"
              className="w-full h-10 rounded-lg bg-sky-500 text-white font-semibold hover:bg-sky-600 transition cursor-pointer text-sm"
            >
              Actualizar Usuario
            </button>
          </form>
