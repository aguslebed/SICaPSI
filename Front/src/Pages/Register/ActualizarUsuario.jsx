      ...
      <main className="relative min-h-screen flex items-start justify-center px-4 pt-4 pb-2">
        <section className="w-full bg-white/95 shadow-2xl rounded-lg p-4" style={{ maxWidth: '500px' }}>
          ...
          <form className="space-y-2" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {ROLE_OPTIONS.map((opt) => (
                  <button
                    ...
                    type="button"
                    className={
                      "px-2 py-1.5 rounded-md border transition cursor-pointer text-sm " +
            ...
            <button
              type="submit"
              className="w-full py-1.5 rounded-md bg-sky-500 text-white font-semibold hover:bg-sky-600 transition cursor-pointer text-sm"
            >
              Actualizar Usuario
            </button>
          </form>
