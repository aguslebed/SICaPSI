...
const Niveles = () => {
  ...
  console.log("PROBANDO: ", userData.data.cursos)
  ...
  const Linkbibliografia = (nivelId) => {
    navigate(`/panel/capacitacion/${id}/niveles/${nivelId}`);
  };
  const LinkCapacitacion = (nivelId) => {
    navigate(`/panel/capacitacion/${id}/niveles/${nivelId}/capacitacion`);
  };
  const LinkEvaluacion = (nivelId) => {
    navigate(`/panel/capacitacion/${id}/niveles/${nivelId}/evaluacion`);
  };
