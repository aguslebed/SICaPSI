export class IEnrollmentService {
async enrollUserInTraining(userId, trainingId) { throw new Error('Not implemented'); }  
async unenrollUserFromTraining(userId, trainingId) { throw new Error('Not implemented'); }
async getUsersNotEnrolledInTraining(trainingId) { throw new Error('Not implemented'); }
